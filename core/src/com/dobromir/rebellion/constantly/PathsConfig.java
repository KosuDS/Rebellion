...
public final class PathsConfig {
	...
	public static final String SOUNDS_PATH = "data/sounds/";
	public static final String GRAPHICS_PATH = "data/graphics/";
	...
	public static final String SKINS_CONFIG_FILE = SKINS_PATH + "skins.txt";
}
